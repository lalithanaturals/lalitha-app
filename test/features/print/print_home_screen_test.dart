...
import 'package:lalitha_app/features/print/print_home_screen.dart';
import 'package:lalitha_app/features/print/visiting_card/visiting_card_providers.dart';

import '../../support/localized_test_app.dart';

Widget _printHomeWithOverrides() => ProviderScope(
      overrides: [
      ...
      child: localizedTestApp(home: const PrintHomeScreen()),
    );

void main() {
  testWidgets('PrintHomeScreen lists every Print-module tool', (WidgetTester tester) async {
    await tester.pumpWidget(_printHomeWithOverrides());
