...
final calculatorBranchesProvider = FutureProvider<List<Branch>>((ref) {
  return ref.watch(branchRepositoryProvider).listActive();
});

final calculatorStaffForBranchProvider = FutureProvider.family<List<Staff>, String>((ref, branchId) {
