...
final estimateBranchesProvider = FutureProvider<List<Branch>>((ref) {
  return ref.watch(branchRepositoryProvider).listActive();
});

final estimateStaffForBranchProvider = FutureProvider.family<List<Staff>, String>((ref, branchId) {
